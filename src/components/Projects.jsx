...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "A modern and responsive portfolio website built with React and Tailwind CSS to showcase my skills, projects, resume, and professional profiles.",
      tech: ["React", "Tailwind"],
    ...
    },
    {
      ...
      github:
        "https://github.com/vaibhavarora1205/vaibhavarora1205.github.io.git",
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {project.tech.map((tech) => (
                <span
                  key={tech}
                  className="bg-slate-800 px-3 py-1 rounded-full text-sm text-blue-400"
                >
                  {tech}
                </span>
              ))}
