...
function Hero() {
  return (
    <section
      id="home"
      className="min-h-[80vh] flex flex-col md:flex-row items-center justify-between gap-10 px-6 md:px-12"
    >
      <div>
        ...
        <p className="text-slate-400 max-w-xl">
          ...
          React and Tailwind CSS. Currently learning and creating projects.
        </p>
        <div className="flex gap-5 mt-6">
          <a
            href="https://github.com/vaibhavarora1205"
            target="_blank"
            rel="noreferrer"
          >
            <FaGithub
          ...
          <a
            href="https://www.linkedin.com/in/vaibhavarora1205-/"
            target="_blank"
            rel="noreferrer"
          >
            <FaLinkedin
